...
public class JDialogMaterial extends javax.swing.JDialog {
     ...
     */
    public JDialogMaterial(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        titulos();
        cargarFacultad();
    ...
    public void eliminarTalla(){
        ...
        try {
            ...
            ps=con.prepareStatement("call p_deleteMate(?);");
    ...
    public void modificarTalla(){
        ...
        try {
            ...
            ps=con.prepareStatement("call p_updateMate(?,?)");
            ps.setString(1, jTextFieldCodi.getText());
            ps.setString(2, jTextFieldMaterial.getText());
            ps.execute();
    ...
    public void buscarTalla(){
        ...
        try {
            ...
            ResultSet rs=null;
            Connection con=cn.conectar();
            String sql="SELECT idmaterial,material FROM material "+where;
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panel_all, javax.swing.GroupLayout.PREFERRED_SIZE, 404, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogMaterial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogMaterial dialog = new JDialogMaterial(new javax.swing.JFrame(), true);
