...
public class JDialogVer_cli extends javax.swing.JDialog {
    DefaultTableModel model = new DefaultTableModel();
    Conexion cn = new Conexion();
    limpiar lim = new limpiar();

    /**
     * Creates new form JDialogVer_cli
     */
    public JDialogVer_cli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public void titulosV() {
        String[] tit = {"CODIGO","DNI", "CLIENTE", "TELEFONO","EMAIL","DIRECCION"};
...
//    }
     public void cargarPersona() {
        try {
            ...
            String sql = "select * from v_Per";
            ps = con.prepareStatement(sql);
            rs = ps.executeQuery();
            ResultSetMetaData rsMd = (ResultSetMetaData) rs.getMetaData();
            int canatidadColumnasEs = rsMd.getColumnCount();
            int[] anchosEs = {130, 100, 300, 100,100,200};
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        frmPrueba.text_cod.setText(jTable2.getValueAt(n, 0).toString());
        frmPrueba.text_dni.setText(jTable2.getValueAt(n, 1).toString());
        frmPrueba.text_cliente.setText(jTable2.getValueAt(n, 2).toString());
        frmPrueba.text_telf.setText(jTable2.getValueAt(n, 3).toString());
        frmPrueba.text_Correo.setText(jTable2.getValueAt(n, 4).toString());
        frmPrueba.text_Direccion.setText(jTable2.getValueAt(n, 5).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogVer_cli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogVer_cli dialog = new JDialogVer_cli(new javax.swing.JFrame(), true);
