...
public class frmModelo extends javax.swing.JFrame {
    ...
    public void insertTalla(){
        ...
        try {
          Connection con=cn.conectar();
          ps=con.prepareStatement("call p_insertModel(?,?);");
    ...
    public void eliminarTalla(){
        ...
        try {
            ...
            ps=con.prepareStatement("call p_deleteModel(?);");
    ...
    public void cargarDatos(){
        ...
        jFormattedTextField1.setText(jTableTalla.getValueAt(n, 0).toString());
    ...
    public void modificarTalla(){
        ...
        try {
            ...
            ps=con.prepareStatement("call p_updateModel(?,?)");
            ps.setString(1, jFormattedTextField1.getText());
            ps.setString(2, jTextFieldTalla.getText());
            ps.execute();
    ...
    public void buscarTalla(){
        ...
        try {
            ...
            ResultSet rs=null;
            Connection con=cn.conectar();
            String sql="SELECT idmodelo,nom_modelo FROM modelo "+where;
    ...
    private void initComponents() {
        ...
        jComboBoxBusqueda.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione...", "idmodelo", "nom_modelo" }));
        ...
        panel_all.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, 450, 190));
        ...
        try {
            jFormattedTextField1.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("MOD###")));
        ...
        jLabel3.setText("mo");
        panel_all.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 100, 130, 60));
        ...
        panel_all.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 170, -1, -1));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panel_all, javax.swing.GroupLayout.PREFERRED_SIZE, 500, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
