 ...
 * @author USUARIO
 */
public class frmTipoPrenda extends javax.swing.JFrame {
    DefaultTableModel model=new DefaultTableModel();
    Conexion cn=new Conexion();

    /**
     * Creates new form frmTipoPrenda
     */
    ...
    public void insertTalla(){
        ...
        try {
          Connection con=cn.conectar();
          ps=con.prepareStatement("call p_insertTipo(?,?);");
          ps.setString(1, jTextFieldCodi.getText());
          ps.setString(2,jTextFieldTipo.getText());
          ps.execute();
          JOptionPane.showMessageDialog(null, "Prenda guaradada!!");
          cargarFacultad();
          limpiar();
    ...
    public void eliminarTalla(){
        ...
        try {
            ...
            ps=con.prepareStatement("call p_deleteTipo(?);");
    ...
    public void cargarDatos(){
        ...
        jTextFieldCodi.setText(jTableTalla.getValueAt(n, 0).toString());
        jTextFieldTipo.setText(jTableTalla.getValueAt(n, 1).toString());
        filas=n;
    }
    public void modificarTalla(){
        ...
        try {
            ...
            ps=con.prepareStatement("call p_updateTipo(?,?)");
            ps.setString(1, jTextFieldCodi.getText());
            ps.setString(2, jTextFieldTipo.getText());
            ps.execute();
    ...
    public void buscarTalla(){
        ...
        try {
            ...
            ResultSet rs=null;
            Connection con=cn.conectar();
            String sql="SELECT idtipo_prenda,tipo_prenda FROM tipo_prenda "+where;
    ...
    private void initComponents() {
        ...
        jComboBoxBusqueda.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione...", "idtipo_prenda", "tipo_prenda" }));
        pnel_inf1.add(jComboBoxBusqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 140, -1));

        panel_all.add(pnel_inf1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 350, 40));
        ...
        panel_all.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, 450, 250));
        ...
        pnel_infLayout.setHorizontalGroup(
            ...
            .addGroup(pnel_infLayout.createSequentialGroup()
                ...
                .addGroup(pnel_infLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTextFieldTipo, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        panel_all.add(pnel_inf, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 290, 140));
        ...
        jLabel3.setText("TR");
        panel_all.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 100, -1, 60));
        ...
        panel_all.add(btnBuscarTodo, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 230, 110, 40));
        ...
        panel_all.add(pnl_cab, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 490, 30));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panel_all, javax.swing.GroupLayout.PREFERRED_SIZE, 490, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panel_all, javax.swing.GroupLayout.PREFERRED_SIZE, 557, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTipoPrenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmTipoPrenda().setVisible(true);
            }
        });
    }
