 ...
 * @author PERSONAL
 */
public class frmPract extends javax.swing.JFrame {

    /**
     * Creates new form frmPract
     */
    public frmPract() {
        initComponents();
    }
    public void reportedBoleta(){
        try {
            ...
            int bol=Integer.parseInt(jTextField1.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmPract.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
