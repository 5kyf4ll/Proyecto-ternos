...
public class frmMarcaTela extends javax.swing.JFrame {
    ...
    public void insertTalla() {
        ...
        try {
            ...
            frmModelo_Tela m = new frmModelo_Tela();
            m.setVisible(true);
            String datos = jTextFieldCodi.getText();
            m.jTextField_fk_id_marca_tela.setText(datos);
            ps.execute();
    ...
    public javax.swing.JTextField jTextFieldCodi;
