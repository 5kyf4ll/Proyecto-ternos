...
public class frmProveedor extends javax.swing.JFrame {
    ...
    public void llenarDatos() {
        ...
        jTextField_fk_id_ruc.setText(jTable1.getValueAt(n, 5).toString());
    ...
    public void cargarDatos() {
        try {
            ...
            int i=jTable1.getRowCount()+1;
            jTextField_id_proveedor.setText(Integer.toString(i+1));
    ...
    public void guardarDatos() {
        ...
        try {
            Connection con = cn.conectar();
            ps = con.prepareStatement("insert into Proveedor (idProveedor,Razon_social,Direccion,Telefono,pag_web,ruc)values (?,?,?,?,?,?);");
            ps.setString(1, jTextField_id_proveedor.getText());
            ...
            ps.setString(6, jTextField_fk_id_ruc.getText());
            ps.execute();
    ...
    public void actualizarDatos() {
        ...
        try {
            ...
            ps.setString(5, jTextField_fk_id_ruc.getText());
    ...
    private void initComponents() {
        ...
        jTextField_fk_id_ruc = new javax.swing.JTextField();
        jLabel8 = new javax.swing.JLabel();
        jButton6 = new javax.swing.JButton();
        jButton7 = new javax.swing.JButton();
        jFormattedTextField1 = new javax.swing.JFormattedTextField();
        jTextField_id_proveedor = new javax.swing.JFormattedTextField();
        ...
        jPanel2.add(jTextField_fk_id_ruc, new org.netbeans.lib.awtextra.AbsoluteConstraints(172, 170, 160, -1));
        ...
        try {
            jTextField_id_proveedor.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##########")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        jPanel2.add(jTextField_id_proveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 20, 160, -1));
    ...
    private void jTextField_pagina_webKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_pagina_webKeyPressed
        // TODO add your handling code here:
         if(evt.getKeyCode()==java.awt.event.KeyEvent.VK_ENTER){
            jTextField_fk_id_ruc.requestFocus();
        }
    ...
    public javax.swing.JTextField jTextField_fk_id_ruc;
    private javax.swing.JFormattedTextField jTextField_id_proveedor;
